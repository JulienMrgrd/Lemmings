...
public class LemmingMainGUIBug extends Application {
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.setTitle("Lemmings Bug !");
	...
	private void initGame() {
		ILevel level=new LevelContratBug();
		IGameEng gameEng=new GameEngContratBug();
		joueur=new JoueurContratBug();
	...
	public void initRootLayout() {
		try {
			...
			loader.setLocation(LemmingMainGUIBug.class.getResource("gui/view/PageView.fxml"));
